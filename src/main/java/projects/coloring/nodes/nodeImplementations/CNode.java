...
/* Function Compute est executed upon each message receipt.  If necessary, 
...
/* Function init is called only once.  The color and the timer is 
initialized.

 * Tha hashing table is created. */
